...
export const DEMO_SCRIPT_META = {
  title: "Demo Video Script",
  subtitle: "Simmons Medical Practice Portal — ABC Partners pitch prototype walkthrough",
  runtime: "~6–7 min",
};

export const DEMO_SCRIPT_SCENES: ScriptScene[] = [
  {
    number: "1",
    ...
    beats: [
      {
        onScreen: "Landing page, hero section, slow scroll start.",
        voiceover:
  ...
  {
    number: "2",
    title: "Landing page tour",
    duration: "45s",
    beats: [
      {
        onScreen: "Scroll through hero → trust stats → \"Problems We Solve\" cards.",
        voiceover:
      ...
      {
        onScreen: "Hover/click through the four problem cards one at a time.",
        voiceover:
      ...
      {
        onScreen: "Scroll to the interactive \"Try it — pick a role\" widget. Click through 2–3 roles (Owner, Reception).",
        voiceover:
  ...
  },
  {
    ...
    beats: [
      {
        onScreen: "Click \"Access Your Portal\" → \"I'm a Patient\" → click the \"Olivia Taylor\" demo account.",
        voiceover:
      ...
      {
        onScreen: "Patient home page: upcoming appointment card, overdue recall card, notifications bell.",
        voiceover:
          "Home shows what matters immediately — next appointment, anything overdue like a care plan review, and live notifications.",
      },
      {
        onScreen: "Click \"Book Appointment.\" Walk through all 4 steps: pick a reason chip, pick a provider, pick a real day and time slot, confirm.",
        voiceover:
      ...
      {
        onScreen: "Go to Billing & Medicare — show invoice history, Medicare card, receipt modal.",
        voiceover:
  ...
  {
    number: "4",
    title: "The AI assistant — solving the reminder problem",
    duration: "75s",
    beats: [
      {
        onScreen: "Click the floating chat bubble.",
        voiceover:
          "This is the fix for problem four — no automated reminders. It's not a scripted chatbot demo; it's checking live data.",
      },
      {
        onScreen: "Click \"Book me an appointment\" → click the personalized reason chip → pick a provider → pick a day → pick a time → confirm.",
        voiceover:
      ...
      {
        onScreen: "Click \"View my appointments\" inside the chat, showing the new booking listed.",
        voiceover:
  ...
  {
    number: "5",
    title: "Staff portal — role-based access",
    duration: "2 min",
    beats: [
      {
        onScreen: "Log out, go to \"I'm Practice Staff,\" show the six role cards for a beat before clicking Reception (Sophie Nguyen).",
        voiceover:
          "Now the staff side. Six roles, each seeing only what they need — enforced by the data layer, not just a hidden button.",
      },
      {
        onScreen: "Reception dashboard — point out greyed-out nav items (Claims, Reports, Security, Users).",
        voiceover:
      ...
      {
        onScreen: "Try typing the URL directly to /staff/app/security — show the \"restricted\" screen.",
        voiceover: "Even typing the URL directly doesn't get her in. The access check happens at the data level.",
      },
      {
        onScreen: "Use \"Demo: switch role\" dropdown → switch to Paul Simmons (Owner).",
        voiceover: "Switching to Dr Simmons, the owner — same portal, completely different view.",
      },
      {
        onScreen: "Owner Dashboard: KPI tiles, no-show-by-provider chart, reminders-work dumbbell chart, claims breakdown.",
        voiceover:
      ...
      {
        onScreen: "Click into Claims & Billing, show the Xero sync widget.",
        voiceover:
      ...
      {
        onScreen: "Click Users & Access, click into Sophie Nguyen, click one permission cell to change it live, show the toast.",
        voiceover: "The owner can also change anyone's access on the fly — this updates instantly across the whole portal.",
      },
      {
        onScreen: "Click Security & System, scroll the live audit log.",
        voiceover:
  ...
  {
    number: "6",
    title: "System architecture — how it's built",
    duration: "75s",
    beats: [
      {
        onScreen: "Navigate to \"System & Architecture\" from the footer or nav.",
        voiceover: "For anyone technical in the room, here's how it actually works, visually.",
      },
      {
        onScreen: "Network tab — toggle between Network Diagram and Physical Layout.",
        voiceover:
      ...
      {
        onScreen: "Security tab — click through 2 role scenarios in the interactive flow.",
        voiceover:
  ...
  },
  {
    ...
    beats: [
      {
        onScreen: "Return to landing page, final CTA section.",
        voiceover:
...
export const DEMO_SCRIPT_NOTES = [
